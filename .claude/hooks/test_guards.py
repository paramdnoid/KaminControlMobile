...
def main() -> int:
    blocked_file_paths = [
        ...
        "subdir/artifacts/report.json",
        "pdfs",
        "subdir/pdfs/report.pdf",
        "dist",
        "desktop-converter/dist/bundle.js",
        ".desktop-build",
        "desktop-converter/.desktop-build/renderer/index.html",
        "genesis-mobile-export",
        "subdir/genesis-mobile-export/data.json",
    ...
    blocked_commands = [
        ...
        "cat .git/config",
        "ls artifacts",
        "cat subdir/artifacts/report.json",
        "find artifacts -maxdepth 1 -type f",
        "grep -R foo artifacts",
        "du -sh pdfs",
        "cat subdir/pdfs/report.pdf",
        "ls dist",
        "cat desktop-converter/dist/bundle.js",
        "cat desktop-converter/.desktop-build/renderer/index.html",
        "ls genesis-mobile-export",
        "cat android/key.properties",
        "cat '2026-06-01 - Sicherung Genesis - KOMPLETT - 001.zip'",
        "sed -n '1,20p' .git/config",
        "git show HEAD:.env",
        "git show HEAD:Daten.zip",
        "git cat-file -p HEAD:genesis-export-v2.json",
        "git grep foo HEAD:.env",
        "git diff HEAD:genesis-export-v2.json",
        "rm -rf src",
    ...
    allowed_commands = [
        ...
        "git diff -- CLAUDE.md",
        "git grep foo -- src",
        "git diff --check -- CLAUDE.md README.md package.json .claude .gitignore",
    ]
