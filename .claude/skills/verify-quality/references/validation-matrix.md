...
- `CLAUDE.md`, `.claude/**`, `.gitignore`: parse `.claude/settings.json`, run `npm run claude:validate-settings`, compile `.claude/hooks/*.py`, verify agent `skills:` links, `git diff --check -- CLAUDE.md .claude .gitignore`.
