...
- `CLAUDE.md`, `.claude/**`, `.gitignore`: parse `.claude/settings.json`, compile `.claude/hooks/*.py`, verify agent `skills:` links, run hook simulations, `git diff --check -- CLAUDE.md .claude .gitignore`.
